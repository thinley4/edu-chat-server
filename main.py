...
async def create_item(item: Item):
    ...
    just reformulate it if needed and otherwise return it as is. Give response in simple text."""
    ...
    Use three sentences maximum and keep the answer concise. Give response in simple text.\
